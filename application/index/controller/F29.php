...
class F29 extends AuthController
{
	...
	public function f29quxian()
	 ...
	 public function f29quxianClick()
	 {
		 ...
		 $TemperatureData = Db::name('f29')
		 ->where('time','>',$startTime)
		 ->where('time','<',$endTime)
		 ->field('time,X11,X13,X15,X17,X19,X21,X23')
		 ->select();

		 $HumidityData = Db::name('f29')
		 ->where('time','>',$startTime)
		 ->where('time','<',$endTime)
		 ->field('time,X12,X14,X16,X18,X20,X22,X24')
		 ->select();
